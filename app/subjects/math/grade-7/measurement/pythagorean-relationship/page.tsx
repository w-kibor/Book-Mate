...
const topics = [
  { id: '9.1', title: 'Sides of a Right-angled Triangle', href: '/subjects/math/grade-7/measurement/pythagorean-relationship/sides-right-triangle' },
  { id: '9.2', title: 'The Pythagorean Relationship', href: '/subjects/math/grade-7/measurement/pythagorean-relationship/pythagorean-theorem' },
  { id: '9.3', title: 'Applying the Pythagorean Relationship', href: '/subjects/math/grade-7/measurement/pythagorean-relationship/applying-pythagorean' },
];
    ...
    <section className="space-y-6">
      <div className="flex items-center gap-4">
        <Button asChild variant="ghost" size="sm">
          <Link href="/subjects/math/grade-7/measurement">
